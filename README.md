...
- **Multiple map styles** — Dark Mode (CARTO, default), Standard (OpenStreetMap), Satellite (Esri), and Hybrid (Google), switched instantly without needing to re-apply filters
